describe('ui.handler.click.filename.js', function () {
    ...
    // Can't get this test to pass in FF on SauceLabs only.  Fails sometimes in Safari 5 as well.
    if (!qq.firefox() && !(qq.safari() && navigator.userAgent.indexOf("Version/5.") > 0)) {
